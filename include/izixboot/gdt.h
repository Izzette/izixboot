...
#define GDT_LIMIT_LOW_BITMASK \
	(((0x00000001LL << GDT_LIMIT_LOW_LENGTH)  - 1))
#define GDT_LIMIT_HIGH_BITMASK \
	(((0x00000001LL << GDT_LIMIT_HIGH_LENGTH) - 1) << GDT_LIMIT_LOW_LENGTH)
#define GDT_BASE_LOW_BITMASK \
	(((0x00000001LL << GDT_BASE_LOW_LENGTH)   - 1))
#define GDT_BASE_HIGH_BITMASK \
	(((0x00000001LL << GDT_BASE_HIGH_LENGTH)  - 1) << GDT_BASE_LOW_LENGTH)

// Bitmasks for converting to logical values.
#define GDT_LIMIT_LOW_DEMASK \
	(((0x00000001LL << GDT_LIMIT_LOW_LENGTH)  - 1) << GDT_LIMIT_LOW_OFFSET)
#define GDT_LIMIT_HIGH_DEMASK \
	(((0x00000001LL << GDT_LIMIT_HIGH_LENGTH) - 1) << GDT_LIMIT_HIGH_OFFSET)
#define GDT_BASE_LOW_DEMASK \
	(((0x00000001LL << GDT_BASE_LOW_LENGTH)   - 1) << GDT_BASE_LOW_OFFSET)
#define GDT_BASE_HIGH_DEMASK \
	(((0x00000001LL << GDT_BASE_HIGH_LENGTH)  - 1) << GDT_BASE_HIGH_OFFSET)
#define GDT_ACCESS_DEMASK \
	(((0x00000001LL << GDT_ACCESS_LENGTH)     - 1) << GDT_ACCESS_OFFSET)
#define GDT_FLAGS_DEMASK \
	(((0x00000001LL << GDT_FLAGS_LENGTH)      - 1) << GDT_FLAGS_OFFSET)
#define GDTR_SIZE_DEMASK \
	(((0x000001LL   << GDTR_SIZE_LENGTH)      - 1) << GDTR_SIZE_OFFSET)
#define GDTR_OFFSET_DEMASK \
	(((0x000001LL   << GDTR_OFFSET_LENGTH)    - 1) << GDTR_OFFSET_OFFSET)
